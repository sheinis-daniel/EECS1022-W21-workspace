...
public class TestVendingMachine {
	...
	@Test
	public void test_VeedndingMachine_04() {
		VendingMachine vm = new VendingMachine();
		 
		vm.add("Kitkat Chunky Bar yeet", 7);
		String result = vm.checkStatus();
		assertEquals("Invalid product: Kitkat Chunky Bar yeet", result);
	}
	
	@Test
	public void test_VeedndingMachine_0e4() {
		VendingMachine vm = new VendingMachine();
